...
public class HongIdEntity {
	...
	public HongIdEntity(long id, long hong_id, String tel, String email, String password, String nick_name,
	...
	public String toString() {
		return "HongIdEntity [id=" + id + ", hong_id=" + hong_id + ", tel=" + tel + ", email=" + email + ", password="
