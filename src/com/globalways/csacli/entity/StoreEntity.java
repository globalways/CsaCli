...
public class StoreEntity {
	...
	public StoreEntity(long id, long pid, long store_id, String store_name, String store_sub, String store_alias,
			...
			String store_news, int hits, int sales_cnt, int status, int store_type, String store_qr, String created,
			String updated) {
		super();
		this.id = id;
		this.pid = pid;
	...
	public String toString() {
		return "StoreEntity [id=" + id + ", pid=" + pid + ", store_id=" + store_id + ", store_name=" + store_name
				...
				+ ", sales_cnt=" + sales_cnt + ", status=" + status + ", store_type=" + store_type + ", store_qr="
				+ store_qr + ", created=" + created + ", updated=" + updated + "]";
	}
